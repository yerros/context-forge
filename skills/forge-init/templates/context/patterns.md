# Patterns (exemplar registry)

<!-- The project's emergent patterns: "this is how we do X here", each anchored to
     a real exemplar file — new sibling features MUST read the exemplar and mimic
     it, not reinvent. One entry per pattern:

     ## <pattern-name>            (e.g. crud-feature, list-screen, api-route)
     ...
     forge-build (before implementing a sibling feature). -->
